...
{
    public static class SponsorRequestHelper
    {
        ...
        private static void ShowThanksForSponsorshipMessage()
        {
            ...
            OutputPane.Instance.WriteLine("please raise an issue at https://github.com/mrlacey/ClearlyEditable/issues");
        ...
        private static void ShowPromptForSponsorship()
        {
            ...
            OutputPane.Instance.WriteLine("Sorry to interrupt. I know your time is busy, presumably that's why you installed this extension (Clearly Editable).");
